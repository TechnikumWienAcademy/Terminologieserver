 ...
 */
@WebListener
public class TermAdminServletContextListener  implements ServletContextListener {
    ...
    {
        logger.info("TermAdminServletContextListener: contextInitialized");
        ...
        {
            Logger.getLogger(TermAdminServletContextListener.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    {
        logger.warn("TermAdminServletContextListener: contextDestroyed - started");
        try
        {
        ...
        logger.warn("TermAdminServletContextListener: contextDestroyed - Hibernate Session Factory closed");
