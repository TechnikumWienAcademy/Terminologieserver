          ...
          try
          {
            ...
            if(enquiry.getCollaborationuserExtPerson() != null){
                ...
                if(activateUserEx){
                    ...
                    enquiry.getCollaborationuserExtPerson().setPassword(Password.getSaltedPassword(neuesPW, salt, enquiry.getCollaborationuserExtPerson().getUsername()));
            ...
            if(activateUser){
                ...
                neuesPW = Password.generateRandomPassword(8);
                String salt = Password.generateRandomSalt();
                enquiry.getCollaborationuser().setPassword(Password.getSaltedPassword(neuesPW, salt, enquiry.getCollaborationuser().getUsername()));
