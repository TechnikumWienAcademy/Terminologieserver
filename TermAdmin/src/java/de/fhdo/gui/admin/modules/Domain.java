...
public class Domain extends Window implements AfterCompose, IGenericListActions, IUpdateModal, IGenericTreeActions
{
  ...
  public void onNewClicked(String id)
  {
    ...
    {
      logger.debug("Fehler beim Ã–ffnen der DomainDetails: " + ex.getLocalizedMessage());
      ex.printStackTrace();
    }
  }
  ...
  public void onEditClicked(String id, Object data)
  {
    ...
    else if (data != null && data instanceof de.fhdo.db.hibernate.DomainValue)
    {
      ...
      {
        logger.debug("Fehler beim Ã–ffnen der Domain(Value)Details: " + ex.getLocalizedMessage());
        ex.printStackTrace();
      }
    }
  }
