...
public class RequestBuilder {
    ...
    public static LogoutRequest buildLogoutRequest(String destination, String issuer) {
        LogoutRequest logoutRequest = SAMLHelper.buildSAMLObject(LogoutRequest.class);
        logoutRequest.setID(SAMLHelper.generateSecureRandomId());
