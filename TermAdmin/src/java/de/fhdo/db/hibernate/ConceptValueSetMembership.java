...
public class ConceptValueSetMembership  implements java.io.Serializable {
    ...
    public ConceptValueSetMembership(ConceptValueSetMembershipId id, CodeSystemEntityVersion codeSystemEntityVersion, ValueSetVersion valueSetVersion, String valueOverride, int status, Date statusDate, Boolean isStructureEntry, Long orderNr) {
       this.id = id;
       this.codeSystemEntityVersion = codeSystemEntityVersion;
       this.valueSetVersion = valueSetVersion;
