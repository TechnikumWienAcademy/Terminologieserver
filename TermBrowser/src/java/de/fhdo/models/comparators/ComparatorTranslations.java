...
public class ComparatorTranslations implements Comparator{
    ...
    public int compare(Object o1, Object o2) {
        ...
        int v = LanguageHelper.getLanguageTable().get(String.valueOf(csct1.getLanguageId())).compareTo(LanguageHelper.getLanguageTable().get(String.valueOf(csct2.getLanguageId())));
