...
public class GenericListHeaderType
{
   ...
   * 
   * @param name Spaltenname (Ãœberschrift)
   * @param width Breite der Spalte in Pixel (0 für variable Größe)
   * @param image Bild neben der Ãœberschrift, z.B. /rsc/img/symbols/xyz.png
   * @param showFilter true, wenn ein Filter in der Ãœberschrift gezeigt werden soll (abhängig vom Datentyp)
