...
public class ImportValueSetStatus
{
    ...
    public ImportValueSetStatusResponseType ImportValueSetStatus(ImportValueSetStatusRequestType parameter)
    {
        if (logger.isInfoEnabled())
        {
            logger.info("====== ImportValueSet ImportValueSetStatus ======");
        }

        // Return-Informationen anlegen
        ImportValueSetStatusResponseType response = new ImportValueSetStatusResponseType();
     ...
     */
    private boolean validateParameter(ImportValueSetStatusRequestType Request,
            ImportValueSetStatusResponseType Response)
    {
        boolean erfolg = true;
