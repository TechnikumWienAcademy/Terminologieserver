...
import de.fhdo.db.hibernate.CodeSystemConcept;
...
public class SysParam extends Window implements AfterCompose, IGenericListActions, IUpdateModal
{
  ...
  private GenericListRowType createRowFromSysParam(de.fhdo.db.hibernate.SysParam sysParam)
  {
  ...
  private void initList()
  {
    ...
    try
    {
      ...
      List<de.fhdo.db.hibernate.SysParam> paramList = hb_session.createQuery(hql).list();

      for (int i = 0; i < paramList.size(); ++i)
      {
        de.fhdo.db.hibernate.SysParam sysParam = paramList.get(i);
  ...
  public void onNewClicked(String id)
  {
    ...
    try
    {
      Window win = (Window) Executions.createComponents(
              "/gui/admin/modules/sysParamDetails.zul", null, null);
  ...
  public void onEditClicked(String id, Object data)
  {
    ...
    //throw new UnsupportedOperationException("Not supported yet.");
    if (data != null && data instanceof de.fhdo.db.hibernate.SysParam)
    {
      de.fhdo.db.hibernate.SysParam sysParam = (de.fhdo.db.hibernate.SysParam) data;
      ...
      try
      {
        ...
        Window win = (Window) Executions.createComponents(
                "/gui/admin/modules/sysParamDetails.zul", null, map);
  ...
  public void onDeleted(String id, Object data)
  {
    ...
    if (data != null && data instanceof de.fhdo.db.hibernate.SysParam)
    {
      ...
      try
      {
        de.fhdo.db.hibernate.SysParam sysParamDB = (de.fhdo.db.hibernate.SysParam) hb_session.get(de.fhdo.db.hibernate.SysParam.class, sysParam.getId());
  ...
  {
    if (o != null && o instanceof de.fhdo.db.hibernate.SysParam)
    {
      ...
      de.fhdo.db.hibernate.SysParam sysParam = (de.fhdo.db.hibernate.SysParam) o;
      GenericListRowType row = createRowFromSysParam(sysParam);
