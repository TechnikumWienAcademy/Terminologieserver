...
public class MaintainConceptValueSetMembership
{
  ...
  public MaintainConceptValueSetMembershipResponseType MaintainConceptValueSetMembership(MaintainConceptValueSetMembershipRequestType parameter)
  {
    ...
    try{
      ...
      try
      {
        ...
        if(cvsm.getAwbeschreibung()!= null)
            cvsm_db.setAwbeschreibung(cvsm.getAwbeschreibung());
        if(cvsm.getBedeutung()!= null)
            cvsm_db.setBedeutung(cvsm.getBedeutung());
        if(cvsm.getHinweise()!= null)
            cvsm_db.setHinweise(cvsm.getHinweise());
