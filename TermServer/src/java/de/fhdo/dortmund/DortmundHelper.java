...
//import de.fhdo.ws.loginserver.AuthenticateRequestType;
//import de.fhdo.ws.loginserver.AuthenticateResponseType;
//import de.fhdo.ws.loginserver.AuthenticateType;
...
public class DortmundHelper
{
  ...
  public static AuthenticateResponseType tryLogin(String Token)
  {
    ...
    //if (SessionHelper.getUserID() == 0)
    {
      ...
      if (token != null && token.length() > 0)
      {
        ...
        //ZAuthenticateResponseType response = authenticate(request);
  ...
  private static AuthenticateResponseType authenticate(de.fhdo.ws.loginserver.AuthenticateRequestType parameter)
  {
    de.fhdo.ws.loginserver.Authorization_Service service = new de.fhdo.ws.loginserver.Authorization_Service();
    de.fhdo.ws.loginserver.Authorization port = service.getAuthorizationPort();
